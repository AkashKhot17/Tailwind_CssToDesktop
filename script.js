...
let nav=document.getElementById('nav-dialog');
...
//         const ddEle=document.getElementById(dtId);
//         ddEle.classList.toggle('hidden');
//         let ikon=element.querySelectorAll('i')[0];
//         ikon.classList.toggle('-rotate-180');
